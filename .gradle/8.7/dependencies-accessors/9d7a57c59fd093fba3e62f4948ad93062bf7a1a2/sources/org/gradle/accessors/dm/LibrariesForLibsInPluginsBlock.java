...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final Vinchamp77LibraryAccessors laccForVinchamp77LibraryAccessors = new Vinchamp77LibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>vinchamp77</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Vinchamp77LibraryAccessors getVinchamp77() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForVinchamp77LibraryAccessors;
    }
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>androidx.splash</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class AndroidxComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>material</b> with <b>androidx.compose.material3:material3</b> coordinates and
         * with version reference <b>androidxComposeMaterial</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxComposeUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>androidxComposeUi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxSplashLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>screen</b> with <b>androidx.core:core-splashscreen</b> coordinates and
         * with version reference <b>androidxSplashScreen</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class Vinchamp77LibraryAccessors extends SubDependencyFactory {

        public Vinchamp77LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>buildutils</b> with <b>com.github.vinchamp77:buildutils</b> coordinates and
         * with version reference <b>buildUtils</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getBuildutils() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("vinchamp77.buildutils");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanistSystemUiController</b> with value <b>0.30.1</b>
         * <p>
        ...
        /**
         * Version alias <b>androidxComposeCompiler</b> with value <b>1.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxComposeMaterial</b> with value <b>1.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxComposeUi</b> with value <b>1.6.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxLifecycle</b> with value <b>2.8.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>buildUtils</b> with value <b>0.0.11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBuildUtils() { return getVersion("buildUtils"); }
    ...
    public static class AndroidxBundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>androidx.lifeycle</b> which contains the following dependencies:
         * <ul>
         ...
         */
        @Deprecated
        public Provider<ExternalModuleDependencyBundle> getLifeycle() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("androidx.lifeycle");
        }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final DiffplugPluginAccessors paccForDiffplugPluginAccessors = new DiffplugPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.diffplug</b>
         */
        public DiffplugPluginAccessors getDiffplug() {
            return paccForDiffplugPluginAccessors;
        }
    ...
    public static class DiffplugPluginAccessors extends PluginFactory {

        public DiffplugPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>diffplug.spotless</b> with plugin id <b>com.diffplug.spotless</b> and
         * with version reference <b>spotless</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getSpotless() { return createPlugin("diffplug.spotless"); }
